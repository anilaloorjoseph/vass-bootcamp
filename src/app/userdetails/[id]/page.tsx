      ...
      {user && (
        <div className="container w-full mx-auto mt-5 mb-2 py-2">
          ...
          <div className="grid grid-cols-2  gap-4">
            <div>
              <small className="text-red-500 font-semibold">user name </small>
              <p> {user?.username}</p>
            </div>
            <div>
              <small className="text-red-500 font-semibold">First name </small>
              <p> {user?.firstname}</p>
            </div>
            <div>
              <small className="text-red-500 font-semibold">Last name </small>
              <p>{user?.lastname}</p>
            </div>
            <div>
              <small className="text-red-500 font-semibold">Roles </small>
              <div className="flex">
                {user?.roles &&
      ...
      <div className="my-2">
        <form onSubmit={handleSubmit(handleAddRole)}>
          <div className="container w-full mx-auto mt-5">
            <h2 className="font-semibold">Add role to the user</h2>
